...
void SBomber::CheckCollisions()
{
    chDetect.CheckCollisions(FindPlane()->GetX(),FindLevelGUI()->GetFinishX(),exitFlag,FindAllBombs(),vecDynamicObj, score, FindGround(), FindDestoyableGroundObjects(), vecStaticObj);
}
